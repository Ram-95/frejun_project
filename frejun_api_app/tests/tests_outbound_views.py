...
"""
    def test_outbound_all_parameters_valid_POST_and_text_is_not_STOP_POST(self):
    ...
    def test_outbound_all_parameters_valid_and_text_is_STOP_Uppercase_POST(self):
        self.data['text'] = "STOP"
        response = self.client.post(
            reverse('outbound'), self.data, format='json')
        self.assertEquals(response.status_code, status.HTTP_200_OK)
    ...
    def test_outbound_all_parameters_valid_and_text_is_STOP_lowercase_POST(self):
        self.data['text'] = "stop"
        response = self.client.post(
            reverse('outbound'), self.data, format='json')
        self.assertEquals(response.status_code, status.HTTP_200_OK)
    ...
    def test_outbound_all_parameters_valid_and_text_is_STOP_with_ending_spaces_and_returns_POST(self):
        self.data['text'] = "STOP\r\n"
        response = self.client.post(
            reverse('outbound'), self.data, format='json')
        self.assertEquals(response.status_code, status.HTTP_200_OK)
